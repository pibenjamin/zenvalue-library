...
<ul>
    <li>Résultat Clé 1 : Classer  dans des rangements accéssibles 100 % des livres selon une catégorisation thématique pertinente d'ici la fin février 2025.</li>
    <li>Résultat Clé 2 : Étiqueter tous les livres avec un code unique et une signalétique claire d'ici la fin février.</li>
    <li>Résultat Clé 3 : Mettre en place un système de prêt manuel pour suivre les emprunts et retours avec une précision de 95 % dès le premier mois.</li>
</ul>
...
<ul>
    <li>Résultat Clé 1 : Qualité des données : 100% des ouvrages ont un titre, un auteur, une date de publication, une ISBN, une couverture</li>
